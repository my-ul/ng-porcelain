...
import { faChevronDown, faTimesCircle, faSearch } from '@fortawesome/free-solid-svg-icons';
...
@Component({
	selector: 'porcelain-search-dropdown, p-search-dropdown',
	templateUrl: './search-dropdown.component.html',
	styleUrls: ['./search-dropdown.component.scss'],
	host: {
		'[class.search-dropdown--has-focus]': 'hasFocus'
	}
})
export class SearchDropdownComponent extends Loggable implements OnInit {
	/**
	 ...
	 */
	readonly name = 'SearchDropdownComponent';
	 ...
	 */
	@HostBinding('class.search-dropdown--has-border')
	@Input()
	border: boolean = true;
