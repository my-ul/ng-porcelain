(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fortawesome/angular-fontawesome'), require('@fortawesome/free-solid-svg-icons'), require('moment'), require('@angular/animations'), require('@angular/platform-browser/animations'), require('@angular/forms'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('porcelain', ['exports', '@fortawesome/angular-fontawesome', '@fortawesome/free-solid-svg-icons', 'moment', '@angular/animations', '@angular/platform-browser/animations', '@angular/forms', '@angular/core', '@angular/common'], factory) :
    (factory((global.porcelain = {}),global.angularFontawesome,global.freeSolidSvgIcons,global.moment,global.ng.animations,global.ng.platformBrowser.animations,global.ng.forms,global.ng.core,global.ng.common));
}(this, (function (exports,angularFontawesome,freeSolidSvgIcons,moment,animations,animations$1,forms,core,common) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SimpleRefinerComponent = (function () {
        function SimpleRefinerComponent() {
            // Outputs
            this.onRefinerChange = new core.EventEmitter();
            // Icons
            this.faChevronDown = freeSolidSvgIcons.faCaretDown;
            this.contractIcon = freeSolidSvgIcons.faChevronUp;
            this.expandIcon = freeSolidSvgIcons.faChevronDown;
        }
         ...
         */
            function () {
                var _this = this;
                return Object.keys(this.value).filter((function (key) { return _this.value[key]; }));
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                var _this = this;
                return Object.keys(this.value).every((function (paramName) { return _this.value[paramName] === true; }));
            };
        /**
         * @return {?}
         */
        ...
        SimpleRefinerComponent.propDecorators = {
            refiner: [{ type: core.Input }],
            _showCount: [{ type: core.Input, args: ['showCount',] }],
            _isOpen: [{ type: core.Input, args: ['isOpen',] }],
            _isExpanded: [{ type: core.Input, args: ['isExpanded',] }],
            onRefinerChange: [{ type: core.Output }]
        };
    ...
    var SimpleRefinerModule = (function () {
    ...
    /** @type {?} */
    var generateSlideInOut = (function (triggerName, openStyle, closedStyle, animationDurationMs) {
        if (triggerName === void 0) {
            triggerName = defaultTriggerName;
        }
        if (openStyle === void 0) {
            openStyle = defaultOpenStyle;
        }
        if (closedStyle === void 0) {
            closedStyle = defaultClosedStyle;
        }
        if (animationDurationMs === void 0) {
            animationDurationMs = defaultAnimationDurationMs;
        }
        return animations.trigger(triggerName, [
            animations.state('in', animations.style(openStyle)),
            animations.transition(':leave', [
                animations.style(openStyle),
                animations.group([animations.animate(animationDurationMs + "ms", animations.style(closedStyle))])
            ]),
            animations.transition(':enter', [
                animations.style(closedStyle),
                animations.group([animations.animate(animationDurationMs + "ms", animations.style(openStyle))])
            ])
        ]);
    });
    /** @type {?} */
    var optionsInOut = animations.animation([generateSlideInOut('optionsInOut')]);
     ...
     */
    /** @type {?} */
    var momentFloor = (function (arg1, arg2) {
        return moment()
            .set('hours', 0)
            .set('minutes', 0)
            .set('seconds', 0);
    ...
    /** @type {?} */
    var momentFloorSubtract = (function (arg1, arg2) { return momentFloor().subtract(arg1, arg2); });
    /** @type {?} */
    var momentFloorAdd = (function (arg1, arg2) { return momentFloor().add(arg1, arg2); });
    /** @type {?} */
    var defaultDateOptions = {
        // yields no range by default (unrestricted)
        '-1': new DateOption({
            slug: '-1',
            getTo: (function () { return null; }),
            getFrom: (function () { return null; }),
            label: 'View All'
        }),
        ...
        '1': new DateOption({
            label: 'Today',
            slug: '1',
            getTo: (function () { return momentFloorAdd(1, 'day').toDate(); }),
            getFrom: (function () { return momentFloor().toDate(); })
        }),
        '7': new DateOption({
            label: 'Last 7 Days',
            slug: '7',
            getTo: (function () { return momentFloorAdd(1, 'day').toDate(); }),
            getFrom: (function () { return momentFloorSubtract(7, 'days').toDate(); })
        }),
        '30': new DateOption({
            label: 'Last 30 Days',
            slug: '30',
            getTo: (function () { return momentFloorAdd(1, 'day').toDate(); }),
            getFrom: (function () { return momentFloorSubtract(30, 'days').toDate(); })
        }),
        '90': new DateOption({
            label: 'Last 90 Days',
            slug: '90',
            getTo: (function () { return momentFloorAdd(1, 'day').toDate(); }),
            getFrom: (function () { return momentFloorSubtract(90, 'days').toDate(); })
        }),
        custom: new DateOption({
            isSelected: true,
            label: 'Date Range...',
            slug: 'custom',
            getTo: (function (toString) { return moment(toString).toDate(); }),
            getFrom: (function (fromString) { return moment(fromString).toDate(); })
        })
    };
    /** @type {?} */
    ...
    var DateRefinerComponent = (function () {
    ...
    var DateRefinerModule = (function () {
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var RefinersComponent = (function () {
        function RefinersComponent() {
            // Outputs
            this.onRefinersChange = new core.EventEmitter();
            // Icons
            // State
            this.values = {};
        }
                        ...
                        return __spread(result, [
                            encodeURIComponent(paramKey) +
                                ...
                                _this.values[paramKey]
                                    .map((function (val) { return encodeURIComponent(val); }))
                                    .join(',')
                        ]);
                    }
        ...
        RefinersComponent.propDecorators = {
            refiners: [{ type: core.Input }],
            onRefinersChange: [{ type: core.Output }]
        };
    ...
    var SimpleRefiner = (function (_super) {
    ...
    exports.SimpleRefinerModule = SimpleRefinerModule;
    exports.DateRefinerModule = DateRefinerModule;
    exports.RefinersModule = RefinersModule;
    exports.SimpleOption = SimpleOption;
    exports.DateOption = DateOption;
    exports.SimpleOptions = SimpleOptions;
    exports.RefinerBase = RefinerBase;
    exports.SimpleRefiner = SimpleRefiner;
    exports.DateRefiner = DateRefiner;
    exports.DateRefinerValue = DateRefinerValue$1;
    exports.ɵg = DateRefinerComponent;
    exports.ɵb = DATE_REFINER_IMPORTS;
    exports.ɵh = RefinersComponent;
    exports.ɵc = REFINERS_IMPORTS;
    exports.ɵf = SimpleRefinerComponent;
    exports.ɵa = SIMPLE_REFINER_IMPORTS;
    exports.ɵe = TruncateComponent;
    exports.ɵd = TruncateModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=porcelain.umd.js.map